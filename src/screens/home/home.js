    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ paddingBottom: 200 }}>
        {prodotti.data.map(el => (
          ...
          <SceltaProdotto nomeMobile={el.nomeMobile} descrizione={el.descrizioneMobile} cambioScheda={() => { navigation.navigate(ProdottoScreen.id, { itemId: el.idMobile }) }} numeroRender={el.idMobile} />
        ))}
      </ScrollView>
    </View>
  )
